...
<nav class="navbar navbar-expand-lg navbar-light" style="background: linear-gradient(182deg, #71b7e6, #9b59b6); border-box:white;");>

<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">

<div class="container-fluid">
  <a class="navbar-brand" href="index.jsp"><h3><i>Coolpoint</i></h3></a>
...
<div class="modal fade" id="showprofilemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    ...
    background: linear-gradient(182deg, #71b7e6, #9b59b6);"
      >
  ...
  <div class="container text-center">
       <button type="button" class="btn  text-light" data-dismiss="modal" style="
    background: linear-gradient(182deg, #71b7e6, #9b59b6);">Close</button>
  </div>   
</form>
      </div>
    </div>
...
<div class="row">
      <form action="OrderServlet" method="post">
          ...
          <input type="submit" class="btn  text-light ml-5" value="Order" style="background: linear-gradient(182deg, #71b7e6, #9b59b6); border-box:white;">
      </form>
...
<div class="modal fade logout-modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-body text-center">
          ...
          <div class="text-center">
            <a href="LoginServlet"><button type="button" class="btn  text-white" style="
    background: linear-gradient(182deg, #71b7e6, #9b59b6);"
            > Yes</button></a>
  ...
  <div class="modal-dialog modal-lg">
    ...
    background: linear-gradient(182deg, #71b7e6, #9b59b6);"
              ...
              An e-commerce website, by definition, is a website that allows you to buy and sell tangible goods,
               digital products or services online. Trade, be it barter exchange or buying and selling of goods and
                services has been prevalent for centuries. No one can be self-sufficient. And this brings out the need
                 for demand and supply of goods and services.<br><br> Transactions have been going on all over  locally, and across locations. Keeping the same concept in mind, now think electronic.
      ...
      <div class="modal-footer">
       <div class="text-center">
        <button type="button" class="btn  text-white" data-dismiss="modal" style="
    background: linear-gradient(182deg, #71b7e6, #9b59b6);" >Close</button>
       </div>
      </div>
    </div>
    ...
    background: linear-gradient(182deg, #71b7e6, #9b59b6);">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="images/phonee.png" style="width:27px;" alt="img">+91 8652617135 / +91 9768092069<br>
                <img src="images/emaill.png" style="width:29px;" alt="img">coolpoint0041@gmail.com<br>
                 <a href="https://g.page/cool-point-maharashtra?share" style="text-decoration:none; color:black;" class="links"><i
                        class="fa-solid fa-map-marker-alt" > </i>Shop No, 2, Dargah Rd, New Prakash Nagar, Sonapur,
...
<div class="modal fade changepasswordmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header  text-white text-center" style="background=linear-gradient(182deg, #71b7e6, #9b59b6);">
  ...
  <div class="container text-center">
       ...
       <input type="submit" class="btn  text-light" value="Change" style="
    background: linear-gradient(182deg, #71b7e6, #9b59b6);"
       >
       <button type="button" class="btn  text-light ml-5" data-dismiss="modal" style="
    background: linear-gradient(182deg, #71b7e6, #9b59b6);"
       >Close</button>
...
<div class="modal fade forgetpasswordmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  ...
  <div class="container text-center">
    ...
    background: linear-gradient(182deg, #71b7e6, #9b59b6);"
       >
       <button type="button" class="btn  text-light ml-5" data-dismiss="modal" style="background: linear-gradient(182deg, #71b7e6, #9b59b6);">Close</button>
