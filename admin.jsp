...
<title>Admin Coolpoint || Online Order Coal-Drink & water</title>
      ...
      <div class="row mt-3">
           <div class="col-md-3">
                 <div class="card hover" data-toggle="modal" data-target="#show-users-modal">
                     <div class="card-body text-center">
                         <div class="container">
                             <img style="max-width:120px" class="img-fluid rounded-circle" src="images/man.png" alt="users_pic" >
                         </div>
           ...
           <div class="col-md-3">
            ...
            <div class="col-md-3">
                  <div class="card hover" data-toggle="modal" data-target="#show-cloth-modal">
                     <div class="card-body text-center">
                          <div class="container">
                             <img style="max-width:120px" class="img-fluid rounded-circle" src="images/coal.png" alt="users_pic" >
                         </div>
                          <h1><%=new ClothDaoImp().getTotalCloth() %></h1>
                          <h2 class="text-uppercase text-muted">Cold Drink</h2>
                     </div>
                 </div>
           </div> 
           ...
           <div class="col-md-3">
                  <div class="card hover" data-toggle="modal" data-target="#show-product-modal">
                     <div class="card-body text-center">
                           <div class="container">
                             <img style="max-width:120px" class="img-fluid rounded-circle" src="images/trolley.png" alt="users_pic" >
                           </div>
      ...
      <div class="row mt-3" >
           <div class="col-md-3">
                 <div class="card hover" data-toggle="modal" data-target="#total-order-modal">
                     <div class="card-body text-center">
                         <div class="container">
                             <img style="max-width:120px" class="img-fluid rounded-circle" src="images/bill.png" alt="users_pic" >
                         </div>
                  ...
                  <div class="card hover" data-toggle="modal" data-target="#add-category-modal">
                     <div class="card-body text-center">
                          <div class="container md-5">
                             <img style="max-width:120px" class="img-fluid rounded-circle" src="images/brandadd.png" alt="users_pic" >
                         </div>
         ...
         <div class="col-md-3">
                  <div class="card hover" data-toggle="modal" data-target="#add-cloth-modal">
                     <div class="card-body text-center">
                          <div class="container md-5">
                             <img style="max-width:120px" class="img-fluid rounded-circle" src="images/add-to-cart.png" alt="users_pic" >
                         </div>
                          <p class="text-lowercase text-muted mt-2 " style="font-size:22px">click to add Cold Drinks</p>
                          <h2 class="text-uppercase text-muted mt-1">Add Cold Drink Types</h2>
                     </div>
                 </div>
           </div>
           ...
           <div class="col-md-3">
                  <div class="card hover" data-toggle="modal" data-target="#add-product-modal">
                     <div class="card-body text-center">
                          <div class="container">
                             <img style="max-width:120px" class="img-fluid rounded-circle" src="images/shopping-cart.png" alt="users_pic" >
                         </div>
...
<div class="modal fade" id="add-category-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header  text-white" style="background: linear-gradient(182deg, #71b7e6, #9b59b6); border-box:white;">
      ...
      <div class="modal-body">
          <form action="ProductOperationServlet" method="post">
               ...
               <div class="container text-center">
                   <button class="btn  text-white" style="background: linear-gradient(182deg, #71b7e6, #9b59b6); border-box:white;">Add Brand</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="ProductOperationServlet" method="post">
               ...
               <div class="form-group">
                   <input type="text" class="form-control" name="clothTitle" placeholder="Enter Product Title here" required>
               </div>
               
               <div class="form-group">
                   <textarea style="height:250px" class="form-control" name="clothDescription" placeholder="Enter Product Description here" required></textarea>
               </div>
               
               <div class="container text-center">
                   <button class="btn  text-white" style="background: linear-gradient(182deg, #71b7e6, #9b59b6); border-box:white;">Add Product</button>
                   <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
               </div>   
          </form>
      </div>
...
<div class="modal fade" id="show-users-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header  text-white text-center" style="background: linear-gradient(182deg, #71b7e6, #9b59b6); border-box:white;">
      ...
      <div class="table-responsive">
          <table class="table">
  <thead class=" text-white" style="background: linear-gradient(182deg, #71b7e6, #9b59b6); border-box:white;">
    <tr>
...
<!-- show Cloth modal -->
 ...
 <div class="modal fade" id="show-cloth-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header  text-white text-center" style="background: linear-gradient(182deg, #71b7e6, #9b59b6); border-box:white;">
        <h5 class="modal-title" id="exampleModalLongTitle" >Total Products</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
        ...
        <div class="container text-center text-md-left" style="font-size: 20px;">
            <div class="row text-center text-md-left">
                ...
                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                    ...
                    <p>
                        <a href="#Product" class="links"><i class="fa-solid fa-arrow-right"></i>Product</a>
                    </p>
                    <p>
                        <a href="#About us" class="links"><i class="fa-solid fa-arrow-right"></i>About us</a>
                    </p>
                    <p>
